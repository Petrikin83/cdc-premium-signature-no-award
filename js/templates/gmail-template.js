...
function buildGmailSignature(data) {
  ...
  <tr>
    ...
    <!-- Transparent width anchor — 184 px (preserves table geometry in Gmail iOS) -->
    <td width="184" valign="middle" bgcolor="#ffffff"
        style="background-color: #ffffff; padding: 0; vertical-align: middle;">
      <img src="${CDC_CONFIG.assets.transparentAnchor}"
           width="184"
           height="1"
           alt=""
           style="display: block; width: 184px; height: 1px; border: 0; margin: 0;">
    </td>
      ...
      <table width="580" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td width="290" valign="middle"
              style="width: 290px; padding: 0 32px 8px 0; vertical-align: middle; white-space: nowrap;">
            ${useLinkedin
          ...
          <td width="290" valign="middle"
              style="width: 290px; padding: 0 0 8px 0; vertical-align: middle; white-space: nowrap;">
        ...
        <tr>
          <td width="290" valign="middle"
              style="width: 290px; padding: 0 32px 0 0; vertical-align: middle; white-space: nowrap;">
          ...
          <td width="290" valign="middle"
              style="width: 290px; padding: 0; vertical-align: middle; white-space: nowrap;">
